...
public class ComputerInfo extends ProductInfo {
	...
	public void displayProductInfo() {
		...
		System.out.println("메인메모리정보 : "+ this.ramInfo);
		System.out.println("하드디스크정보 : "+ this.hddInfo);

	}

	public void setComputerInfo(String productCompany, String productName,
			String productSerialID, String cpuInfo, String ramInfo,
			String hddInfo) {
